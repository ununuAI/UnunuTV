  ...
  return <section className="canvas-timeline-dock" style={{ height }} aria-label="底部专业时间线">
    ...
    <header className="timeline-command-bar">
      ...
      <div className="timeline-command-actions">
        ...
        <button disabled={readOnly || !videoClips.length || ["queued", "running"].includes(latestRender?.status)} onClick={() => void renderPreset("h264_vertical", "9:16 竖版交付")} title="导出 1080×1920 竖版，并附交换与音频文件" type="button"><Download size={14} />9:16</button>
