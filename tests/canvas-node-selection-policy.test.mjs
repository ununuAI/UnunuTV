...
test("generative nodes and Prompt text expose the generic Prompt surface", () => {
  ...
  assert.equal(shouldShowNodePrompt({ node: { kind: "text", payload: { textMode: "plain" } }, selected: true, selectionCount: 1 }), false);
  assert.equal(shouldShowNodePrompt({ node: { kind: "text", payload: { textMode: "prompt" } }, selected: true, selectionCount: 1 }), true);
